...
async def main_interactive_loop():
    ...
    try:
        ...
        while True:
            user_text = input("\nВведите ваш вопрос или фразу (или 'q'/'quit' для выхода): ")
            ...
            try:
                ...
                if text_answer:
                    print(f"Текстовый ответ: {text_answer}")
                else:
                    print("Не удалось извлечь прямой текстовый ответ. Полная структура ответа:")
                ...
                if audio_data:
                    ...
                    print("Аудиоответ не был получен (хотя запрашивался).")
